...
app.get('/assignments', async (req, res) => {
  try {
    const { difficulty, search } = req.query; // Get query parameters
    const query = {};
    ...
    // Fetch filtered and/or searched assignments
...
app.get('/',(req, res) => {
    res.send('MatrimonyHub is a platform')
})

app.listen(port, () => {
    console.log(`MatrimonyHub is waiting at: ${port}`)
})