...
app.get('/submissions', async (req, res) => {
  ...
  app.get('/my-attempted-assignments', async (req, res) => {
    const { email } = req.query; // Logged-in user's email passed as a query parameter
    ...
    try {
      const assignments = await submissionsCollection.find({ email }).toArray(); // Filter by email
