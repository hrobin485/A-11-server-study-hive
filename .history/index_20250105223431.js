...
app.get('/submissions', async (req, res) => {
 ...
 // In your Express route handler for updating submission marks
app.post('/give-mark/:submissionId', async (req, res) => {
    ...
    try {
      ...
      const updatedSubmission = await Submission.findByIdAndUpdate(
        submissionId,
        { marks, feedback, status: 'completed' }, // Mark as completed
        { new: true } // Return the updated submission
      );
